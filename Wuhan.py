...
def search_for_hashtags(consumer_key, consumer_secret, access_token, access_token_secret, hashtag_phrase):
    ...
    """
    # Create authentication for accessing Twitter(ref:https://developer.twitter.com/en/docs)
    ...
    with open('%s.csv' % (fname), 'w', encoding="utf-8") as file:
        ...
        w.writerow(['timestamp', 'tweet_text', 'username', 'all_hashtags', \
                    ...
                    'verified_account', 'coordinates', 'favorite_count', 'retweet_count'])
        ...
        #Number of tweets could be changed here
            w.writerow([tweet.created_at, tweet.full_text.replace('\n',' '), \
                        ...
                        tweet.user.followers_count, tweet.user.location, tweet.user.statuses_count, \
                        tweet.user.verified, tweet.coordinates, tweet.favorite_count, tweet.retweet_count])
...
Hashtags = ['#coronavirus', '#COVID19', '#wuhancoronavirus', '#coronavirus AND #US', '#coronavirus AND #japan', '#COVID19 AND #US','#coronavirus AND #wuhan','#coronavirus AND #hongkong', '#coronavirus AND #LA', '#coronavirus AND #CHICAGO','#coronavirus AND #NY', '#COVID19 AND #ITALY', '#coronavirus AND #ITALY', '#COVID19 AND #Korea', '#coronavirus AND #Korea']
status = input('Status')
